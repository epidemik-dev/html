...
export var NetworkAPI = function () {
    function NetworkAPI() {
    ...
    _createClass(NetworkAPI, null, [{
        ...
        value: function network_login(username, password, sucess, failure) {
        ...
        key: "network_create_an_account",
        value: function network_create_an_account(username, password, latitude, longitude, dob, gender, sucess, failure) {
        ...
        key: "network_get_status",
        value: function network_get_status(username, auth_token, sucess, failure) {
        ...
        key: "network_report_sick",
        value: function network_report_sick(username, disease_name, symptoms, auth_token, sucess, failure) {
        ...
        key: "network_get_all_diseases",
        value: function network_get_all_diseases(auth_token, sucess, failure) {
            var region = {
                lat_min: -600,
                lat_max: 600,
                long_min: -600,
        ...
        key: "network_get_all_trends",
        value: function network_get_all_trends(username, auth_token, sucess, failure) {
        ...
        key: "network_report_healthy",
        value: function network_report_healthy(username, auth_token, sucess, failure) {
            var date = new Date().toISOString().split("T")[0];
            var URL = main_url + "/users/" + username + "/diseases" + version_extension + "&auth_token=" + auth_token + "&date_healthy=" + date;
            $.ajax({
                method: "PATCH",
                contentType: 'application/json',
                dataType: 'json',
        ...
        key: "network_load_diagnosis",
        value: function network_load_diagnosis(auth_token, sucess, failure) {
            var URL = main_url + "/diseases/symptoms" + version_extension + "&auth_token=" + auth_token;
            $.ajax({
                method: "GET",
                contentType: 'application/json',
                dataType: 'json',
